...
Si el usuario menciona un giro concreto, adapta el ejemplo a ese giro. Para una clinica veterinaria puedes mencionar servicios, vacunas, estetica, horarios, costos orientativos si el negocio los proporciona, urgencias, datos del dueño, datos de la mascota, recordatorios y citas.

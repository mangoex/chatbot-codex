...
PROMPT_ASSISTANT_MAX_TOKENS = _int("PROMPT_ASSISTANT_MAX_TOKENS", "16000")
...
RAG_MAX_CHUNKS_PER_DOCUMENT = _int("RAG_MAX_CHUNKS_PER_DOCUMENT", "4")
RAG_MAX_COSINE_DISTANCE = _float("RAG_MAX_COSINE_DISTANCE", "0.75")
RAG_FULL_CONTEXT_MAX_CHARS = _int("RAG_FULL_CONTEXT_MAX_CHARS", "15000")
...
MAX_MEDIA_BYTES = _int("MAX_MEDIA_BYTES", str(16 * 1024 * 1024))
